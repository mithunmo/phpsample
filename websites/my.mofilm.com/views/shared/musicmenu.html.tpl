...
*}
	<body>
		<div style="background: #f6eeb2; width:auto; height:99px;" >
       <div style="width:940px;background: #f6eeb2;margin: 0 auto;  height:99px;  background-image:url(/themes/mofilm/images/mm/catre/headerimage.png); background-repeat:no-repeat;">
       <div style="float:left; width:250px; height:60px; padding-top:5px;"></div>
       <div style="float: right; height:30px; padding-top:40px; font-family:'Trebuchet MS', Arial, Helvetica, sans-serif; color:#58220b; width: 370px;">HOME&nbsp;&nbsp;&nbsp; |&nbsp;&nbsp;&nbsp; MOFILM&nbsp;&nbsp;&nbsp;| &nbsp;&nbsp;&nbsp; ABOUT &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;   FAQ</div>
       </div>
       </div>		{*
		<div id="nav">
			<ul class="primary">
