 ...
 * suppliersModel class
 * 
 * Provides the "suppliers" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category suppliersModel
 */
class suppliersModel extends mofilmSupplier implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmSupplier::listOfObjects($inOffset, $inLimit);
	}
