<?php
/**
 * userNotificationModel.class.php
 * 
 ...
 * @category userNotificationModel
 * @version $Rev: 624 $
 */
 ...
 * userNotificationModel class
 * 
 * Provides the "userNotification" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category userNotificationModel
 */
class userNotificationModel extends mofilmNotification implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmNotification::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		/**
		 * @todo change database and table to the ones required for userNotificationModel
		 */
		$query = '
