 ...
 * channelModel class
 * 
 * Provides the "channel" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category channelModel
 */
class channelModel extends mofilmChannel implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmChannel::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		/**
		 * @todo change database and table to the ones required for channelModel
		 */
		$query = '
