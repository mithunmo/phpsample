<?php
/**
 * territoriesModel.class.php
 * 
 * territoriesModel class
 *
 * @author Dave Redfern
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category territoriesModel
 * @version $Rev: 11 $
 */
 ...
 * territoriesModel class
 * 
 * Provides the "territories" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category territoriesModel
 */
class territoriesModel extends mofilmTerritory implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmTerritory::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		$query = '
			SELECT COUNT(*) AS Count
			  FROM '.system::getConfig()->getDatabase('mofilm_content').'.territories';
