 ...
 * distributionModel class
 * 
 * Provides the "distribution" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category distributionModel
 */
class distributionModel extends mofilmDistribution implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmDistribution::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		/**
		 * @todo change database and table to the ones required for distributionModel
		 */
		$query = '
