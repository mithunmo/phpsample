 ...
 * languagesModel class
 * 
 * Provides the "languages" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category languagesModel
 */
class languagesModel extends mofilmLanguage implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmLanguage::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		$query = '
			SELECT COUNT(*) AS Count
			  FROM '.system::getConfig()->getDatabase('mofilm_content').'.languages';
