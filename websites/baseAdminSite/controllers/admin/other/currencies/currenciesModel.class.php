 ...
 * currenciesModel class
 * 
 * Provides the "currencies" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category currenciesModel
 */
class currenciesModel extends mofilmCurrency implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmCurrency::listOfObjects($inOffset, $inLimit);
	}
