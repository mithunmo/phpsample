 ...
 * typeModel class
 * 
 * Provides the "type" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category typeModel
 */
class typeModel extends momusicType implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return momusicType::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		/**
		 * @todo change database and table to the ones required for typeModel
		 */
		$query = '
