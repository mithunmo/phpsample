<?php
/**
 * HandpickedMusicModel.class.php
 * 
 * HandpickedMusicModel class
 *
 * @author Mithun Mohan
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category HandpickedMusicModel
 * @version $Rev: 624 $
 */
 ...
 * HandpickedMusicModel class
 * 
 * Provides the "HandpickedMusic" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category HandpickedMusicModel
 */
class HandpickedMusicModel extends momusicHandpickedmusic implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return momusicHandpickedmusic::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		/**
		 * @todo change database and table to the ones required for HandpickedMusicModel
		 */
		$query = '
	...
	function getNewObject() {
		return new momusicHandpickedmusic();
	}
