<?php
/**
 * userSignupCodesModel.class.php
 * 
 * userSignupCodesModel class
 *
 * @author Dave Redfern
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category userSignupCodesModel
 * @version $Rev: 11 $
 */
 ...
 * userSignupCodesModel class
 * 
 * Provides the "userSignupCodes" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category userSignupCodesModel
 */
class userSignupCodesModel extends mofilmUserSignupCode implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmUserSignupCode::listOfObjects($inOffset, $inLimit);
	}
	...
	function getNewObject() {
		return new mofilmUserSignupCode();
	}
