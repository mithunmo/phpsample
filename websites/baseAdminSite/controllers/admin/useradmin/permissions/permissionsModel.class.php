 ...
 * permissionsModel class
 * 
 * Provides the "permissions" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category permissionsModel
 */
class permissionsModel extends mofilmPermission implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmPermission::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		$query = '
			SELECT COUNT(*) AS Count
			  FROM '.system::getConfig()->getDatabase('mofilm_content').'.permissions';
