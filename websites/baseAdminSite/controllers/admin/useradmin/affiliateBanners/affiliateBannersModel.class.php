<?php
/**
 * affiliateBannersModel.class.php
 * 
 * affiliateBannersModel class
 *
 * @author Dave Redfern
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category affiliateBannersModel
 * @version $Rev: 91 $
 */
 ...
 * affiliateBannersModel class
 * 
 * Provides the "affiliateBanners" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category affiliateBannersModel
 */
class affiliateBannersModel extends mofilmBanner implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmBanner::listOfObjects($inOffset, $inLimit);
	}
