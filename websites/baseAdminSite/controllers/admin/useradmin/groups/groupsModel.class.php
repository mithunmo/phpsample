 ...
 * groupsModel class
 * 
 * Provides the "groups" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category groupsModel
 */
class groupsModel extends mofilmPermissionGroup implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmPermissionGroup::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		$query = '
			SELECT COUNT(*) AS Count
			  FROM '.system::getConfig()->getDatabase('mofilm_content').'.permissionGroups';
	...
	function getNewObject() {
		return new mofilmPermissionGroup();
	}
