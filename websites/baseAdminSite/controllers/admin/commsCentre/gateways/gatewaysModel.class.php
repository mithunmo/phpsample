 ...
 * gatewaysModel class
 * 
 * Provides the "gateways" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category gatewaysModel
 */
class gatewaysModel extends commsGateway implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return commsGateway::listOfObjects($inOffset, $inLimit);
	}
	...
	function getExistingObject($inPrimaryKey) {
		$this->setGatewayID($inPrimaryKey);
		$this->load();
		return $this;
	}
}