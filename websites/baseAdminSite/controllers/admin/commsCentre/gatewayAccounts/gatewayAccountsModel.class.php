<?php
/**
 * gatewayAccountsModel.class.php
 * 
 * gatewayAccountsModel class
 *
 * @author Dave Redfern
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category gatewayAccountsModel
 * @version $Rev: 11 $
 */
 ...
 * gatewayAccountsModel class
 * 
 * Provides the "gatewayAccounts" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category gatewayAccountsModel
 */
class gatewayAccountsModel extends commsGatewayAccount implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return commsGatewayAccount::listOfObjects($inOffset, $inLimit);
	}
	...
	function getNewObject() {
		return new commsGatewayAccount();
	}
	...
	function getExistingObject($inPrimaryKey) {
		$this->setGatewayAccountID($inPrimaryKey);
		$this->load();
		return $this;
	}
}