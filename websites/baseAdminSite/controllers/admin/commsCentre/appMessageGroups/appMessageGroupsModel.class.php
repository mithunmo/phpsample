<?php
/**
 * appMessageGroupsModel.class.php
 * 
 * appMessageGroupsModel class
 *
 * @author Dave Redfern
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category appMessageGroupsModel
 * @version $Rev: 11 $
 */
 ...
 * appMessageGroupsModel class
 * 
 * Provides the "appMessageGroups" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category appMessageGroupsModel
 */
class appMessageGroupsModel extends commsApplicationMessageGroup implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return commsApplicationMessageGroup::listOfObjects($inOffset, $inLimit);
	}
	...
	function getNewObject() {
		return new commsApplicationMessageGroup();
	}
	...
	function getExistingObject($inPrimaryKey) {
		$this->setMessageGroupID($inPrimaryKey);
		$this->load();
		return $this;
	}
}