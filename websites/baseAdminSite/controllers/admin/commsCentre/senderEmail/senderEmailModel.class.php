<?php
/**
 * senderEmailModel.class.php
 * 
 * senderEmailModel class
 *
 * @author Mithun Mohan
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category senderEmailModel
 * @version $Rev: 624 $
 */
 ...
 * senderEmailModel class
 * 
 * Provides the "senderEmail" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category senderEmailModel
 */
class senderEmailModel extends mofilmCommsSenderemail implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmCommsSenderemail::listOfObjects($inOffset, $inLimit);
	}
	...
	function getNewObject() {
		return new mofilmCommsSenderemail();
	}
