<?php
/**
 * imapServerModel.class.php
 * 
 * imapServerModel class
 *
 * @author Mithun Mohan
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category imapServerModel
 * @version $Rev: 624 $
 */
 ...
 * imapServerModel class
 * 
 * Provides the "imapServer" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category imapServerModel
 */
class imapServerModel extends mofilmCommsImapServerDetail implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmCommsImapServerDetail::listOfObjects($inOffset, $inLimit);
	}
	...
	function getNewObject() {
		return new mofilmCommsImapServerDetail();
	}
