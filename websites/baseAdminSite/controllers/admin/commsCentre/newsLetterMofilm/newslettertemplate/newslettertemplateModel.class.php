<?php
/**
 * newslettertemplateModel.class.php
 * 
 ...
 * @category newslettertemplateModel
 * @version $Rev: 624 $
 */
 ...
 * newslettertemplateModel class
 * 
 * Provides the "newslettertemplate" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category newslettertemplateModel
 */
class newslettertemplateModel extends mofilmCommsNewslettertemplate implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmCommsNewslettertemplate::listOfObjects($inOffset, $inLimit);
	}
	...
	function getNewObject() {
		return new mofilmCommsNewslettertemplate();
	}
	...
	function getHtmlTemplateById($inID){
	    $oMofilmCommsNewletterTemplate = mofilmCommsNewslettertemplate::getInstance($inID);
	    $htmlTemplate = $oMofilmCommsNewletterTemplate->getHtmlTemplate();
	    return $htmlTemplate;
	}
}