<?php
/**
 * mailingListModel.class.php
 * 
 * mailingListModel class
 *
 * @author Mithun Mohan
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category mailingListModel
 * @version $Rev: 624 $
 */
 ...
 * mailingListModel class
 * 
 * Provides the "mailingList" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category mailingListModel
 */
class mailingListModel extends mofilmCommsListType implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmCommsListType::listOfObjects($inOffset, $inLimit);
	}
	...
	function getNewObject() {
		return new mofilmCommsListType();
	}
