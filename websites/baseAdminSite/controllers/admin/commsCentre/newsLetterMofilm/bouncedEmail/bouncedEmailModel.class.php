<?php
/**
 * bouncedEmailModel.class.php
 * 
 * bouncedEmailModel class
 *
 * @author Mithun Mohan
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category bouncedEmailModel
 * @version $Rev: 624 $
 */
 ...
 * bouncedEmailModel class
 * 
 * Provides the "bouncedEmail" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category bouncedEmailModel
 */
class bouncedEmailModel extends mofilmCommsBouncedEmail implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmCommsBouncedEmail::listOfObjects($inOffset, $inLimit);
	}
	...
	function getNewObject() {
		return new mofilmCommsBouncedEmail();
	}
