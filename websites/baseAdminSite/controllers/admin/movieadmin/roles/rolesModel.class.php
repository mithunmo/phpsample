 ...
 * rolesModel class
 * 
 * Provides the "roles" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category rolesModel
 */
class rolesModel extends mofilmRole implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmRole::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		$query = '
			SELECT COUNT(*) AS Count
			  FROM '.system::getConfig()->getDatabase('mofilm_content').'.roles';
