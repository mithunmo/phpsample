 ...
 * categoriesModel class
 * 
 * Provides the "categories" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category categoriesModel
 */
class categoriesModel extends mofilmCategory implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmCategory::listOfObjects($inOffset, $inLimit);
	}
