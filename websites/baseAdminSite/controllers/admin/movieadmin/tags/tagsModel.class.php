 ...
 * tagsModel class
 * 
 * Provides the "tags" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category tagsModel
 */
class tagsModel extends mofilmTag implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmTag::listOfObjects($inOffset, $inLimit);
	}
	...
	function getTotalObjects() {
		$query = '
			SELECT COUNT(*) AS Count
			  FROM '.system::getConfig()->getDatabase('mofilm_content').'.tags';
