 ...
 *
 * Stored in reportQueueController.class.php
 * 
 * @author Dave Redfern
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category reportQueueController
 * @version $Rev: 11 $
 */
 ...
 * reportQueueController
 *
 * reportQueueController class
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category reportQueueController
 */
class reportQueueController extends mvcDaoController {
	...
	function initialise() {
		...
		$this->setControllerView('reportQueueView');
	...
	function addInputFilters() {
		...
		$this->getInputManager()->addFilter('ReportID', utilityInputFilter::filterInt());
	}
	 ...
	 *
	 * @param array $inData
	 * @param reportQueueModel $inModel
	 */
	function addInputToModel($inData, $inModel) {
		$inModel->setScheduled($inData['Scheduled']);
		$inModel->setReportID($inData['ReportID']);
	}
