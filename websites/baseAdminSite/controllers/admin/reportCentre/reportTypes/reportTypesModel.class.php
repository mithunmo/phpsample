<?php
/**
 * reportTypesModel.class.php
 * 
 * reportTypesModel class
 *
 * @author Dave Redfern
 * @copyright Mofilm (c) 2009-2010
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category reportTypesModel
 * @version $Rev: 11 $
 */
 ...
 * reportTypesModel class
 * 
 * Provides the "reportTypes" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category reportTypesModel
 */
class reportTypesModel extends reportCentreReportType implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return reportCentreReportType::listOfObjects($inOffset, $inLimit);
	}
	...
	function getNewObject() {
		return new reportCentreReportType();
	}
	...
	function getExistingObject($inPrimaryKey) {
		$this->setReportTypeID($inPrimaryKey);
		$this->load();
		return $this;
	}
}