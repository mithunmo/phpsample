 ...
 * apiKeyModel class
 * 
 * Provides the "apiKey" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category apiKeyModel
 */
class apiKeyModel extends mofilmSystemAPIKey implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmSystemAPIKey::listOfObjects($inOffset, $inLimit);
	}
