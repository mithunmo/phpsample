 ...
 * helpTagsModel class
 * 
 * Provides the "helpTags" page
 * 
 * @package websites_baseAdminSite
 * @subpackage controllers
 * @category helpTagsModel
 */
class helpTagsModel extends mofilmSystemHelpTags implements mvcDaoModelInterface {
	...
	function getObjectList($inOffset = null, $inLimit = 30) {
		return mofilmSystemHelpTags::listOfObjects($inOffset, $inLimit);
	}
	...
	function getNewObject() {
		return new mofilmSystemHelpTags();
	}
