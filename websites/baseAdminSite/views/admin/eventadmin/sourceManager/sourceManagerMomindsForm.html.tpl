                    ...
                    <td>
                        {if $oController->getAction() == 'newObject'}
                            <select id="public" name="Hidden">
                                ...
                                <option selected value="I">Yes</option>>
                            </select>

                        {else}
                            <select name="Hidden">
                                <option {if $oObject->getHidden() == "Y"}selected={$oObject->getHidden()} {/if} value="Y">No</option>>                        
                                <option {if $oObject->getHidden() == "I"}selected={$oObject->getHidden()} {/if} value="I">Yes</option>>                        
                            </select>

                        {/if}  
                        <p style="float:right; padding: 0px; margin: 0px;"> If Yes, only logo is required. </p>
                    </td>
                            </tr>
    ...
    *}               
    ...
    <div>
        ...
        <div>
            ...
            <tbody>
                <tr>
                     <th style="width:40%">{t}Submissions required{/t}</th>
                        <td >
                            {if $ParamData}
                            <select name="ideaSubmissions">
                                <option value="1" {if $ParamData->getParamValue() == 1} selected {/if}> 1 </option>
                                <option value="2" {if $ParamData->getParamValue() == 2} selected {/if}> 2 </option>
                                <option value="3" {if $ParamData->getParamValue() == 3} selected {/if}> 3 </option>
                                <option value="4" {if $ParamData->getParamValue() == 4} selected {/if}> 4 </option>
                                <option value="5" {if $ParamData->getParamValue() == 5} selected {/if}> 5 </option>
                            </select>
                            {else}
                                <select name="ideaSubmissions">
        ...
        <h3><a href="#">Status <span style="color:orange;float:right"> Published MoMinds projects appear on MOFILM.com</span></a></h3>
        <div>
            <table class="data">
                <tbody>
