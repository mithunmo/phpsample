...
<div class="content">	
    <div class="daoAction">
        {if $oObject->getSourceDataSet()->getHash()}
            <a href="http://www.mofilm.com/competitions/previewmosaicBrand/{$oObject->getSourceDataSet()->getHash()}" title="{t}Preview{/t}" target="_blank">
    ...
    *}               
    ...
    <div>
       ...
       {if $oController->getAction() == 'editObject'}
        ...
        {/if}              
    <h3><a href="#">Status <span style="color:orange;float:right"> Published Mosaic projects appear on MOFILM.com</span></a></h3>
    <div>
        <table class="data">
            <tbody>
