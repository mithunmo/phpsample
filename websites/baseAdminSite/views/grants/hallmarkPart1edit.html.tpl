    ...
    <div class="container">
        ...
        <form id="grantsApprovalForm" class="userGrantsApprovalForm" name="grantsApprovalForm" method="post" action="/grants/doDocsUpload"  enctype="multipart/form-data">
            ...
            <div class="content">
				...
				<h4>What is your interpretation of the problem we need to solve?</h4>
			...
			<div class="formFieldContainer">
				...
				<div class="ui-accordion-content ui-widget-content ui-accordion-content-active ui-corner-top ui-corner-bottom">
					<p class="grantsview">{$oGrant->getFilmConcept()}</p>
                        ...
                        <div class="formFieldContainer">
				<h4>Please complete each sentence: </h4>
                                <div class="ui-accordion-content ui-widget-content ui-accordion-content-active ui-corner-top ui-corner-bottom">
                                    This creative platform will inspire films for Mother’s Day about... 

					<p class="grantsview">{$oGrant->getParamSet()->getParam('question1')}</p>
				</div>
                                <div class="ui-accordion-content ui-widget-content ui-accordion-content-active ui-corner-top ui-corner-bottom">
                                    	This creative platform will inspire films for Holidays about... 

					<p class="grantsview">{$oGrant->getParamSet()->getParam('question2')}</p>
				</div>
				
			</div>        
                                
                                <div class="formFieldContainer">
				<h4>Please provide at least 2 additional executions (using Mother’s Day, Holiday or neither) that could be derived from the creative platform for Social and Point of Sale. </h4>
				<div class="ui-accordion-content ui-widget-content ui-accordion-content-active ui-corner-top ui-corner-bottom">
                ...
                <table width="100%" class="ui-accordion-content ui-widget-content ui-accordion-content-active ui-corner-top ui-corner-bottom" style="padding:20px;">
                    ...
                    <tr>
                        ...
                        <td width="20%" align="center">
                            ...
                            {else}
                                <input id="documentAgreement" type="checkbox" name="DocumentAgreement" value="1" disable />
                            {/if}
