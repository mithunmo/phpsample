...
<div id="body">
	<div class="container">
		...
		<form id="grantsApprovalForm" class="userGrantsApprovalForm" name="userGrantsApprovalForm" method="post" action="/grants/doEdit">
			<div class="content">	
				<div class="daoAction">
					...
					<button type="submit" name="submit" value="Save" title="{t}Save{/t}" id="userMovieGrantsSubmit">
