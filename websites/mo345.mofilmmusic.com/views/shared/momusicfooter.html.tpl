		...
		<div id="footerframe">
			...
			<div class="footer_block1">
				<div style="float:left;width:400px;height:100px;padding-left: 20px;">
					...
					<div style="color:#e85e02;font-weight: bold;padding-left: 80px;font-size: 18px;"> <span style="font-size: 20px;color:#009be3;">{if $oModel} {$oModel->getTotalActiveObjects()} {/if} </span> MOMUSIC Tracks </div>
