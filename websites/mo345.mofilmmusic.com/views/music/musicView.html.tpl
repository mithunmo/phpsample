...
<div id="body" style="background-color:#dcdcdc;">
	...
	<div class="container">
		...
		<div style="width:1000px; height:47px; background-image:url(/themes/mofilm/images/mm/upload/backimage.gif); background-repeat:no-repeat; ">
			...
			<form action="/music/solrSearch" method="GET">
				<div style="float:right; width:35px; padding-right:25px; padding-left:20px; padding-top:7px;"><input class="searchGo1 button" id="nSearch" type="submit" value="GO" style=" width:52px; height:33px; background-color: #5b5a5a;cursor:pointer;"><!--img src="/themes/mofilm/images/mm/catre/go_btn.gif" width="52" height="33" alt="search" /--></div>
		...
		<div id="musicContent">
			...
			{foreach $oResults as $oMusic}		
				...
				<div style=" width:1000px; height:34px; vertical-align:middle; padding:1px; background-color:#b8b7b7">
					<div style="float:right; height:26px; padding-top:8px; width:80px; background-color:#f2f2f2; text-align:center">
						<a style="color:black;" href="/music/license/{$oMusic->s_id}"><img src="/themes/mofilm/images/cart.gif"></a>
					</div>
					<div style="float:right; width:1px;">&nbsp;</div>
					<div style="float:right; height:26px; padding-top:8px; width:90px; background-color:#f2f2f2;  text-align:center ">{$oMusic->s_duration}</div>
					<div style="float:right; width:1px;">&nbsp;</div>
					...
					<div style="float:right; width:1px;">&nbsp;</div>
					<div style="float:right; height:26px; padding-top:8px; width:240px; background-color:#f2f2f2;  text-align:center "><a class="searchArtist" href="/music/solr?artist="{$oMusic->s_artist}>{$oMusic->s_artist} </a></div>

					<div style="float:right; width:1px;">&nbsp;</div>
					<div class="tooltips" style="float:right; height:26px; padding-top:8px; width:59px; background-color:#f2f2f2;  text-align:center ">
						<img src="/themes/mofilm/images/mm/info.png" width=16px height=16px  /> <span class=".tooltip-style2"> {$oMusic->s_description} </span>
					</div>


					<div style="float:right; width:1px;">&nbsp;</div>
					<div style="float:left; height:26px; padding-top:8px; width:466px; background-color:#f2f2f2;  text-align:left; padding-left: 10px"><a class="musicPlay" href="{$oMusic->s_path}"><img style="padding-right:10px;" src="/themes/mofilm/images/mm/play.png" height="16px;"></a>{$oMusic->s_track}</div>
				</div>
			...
			<div style="width:50px;float:left;padding-left: 350px;">
				...
				{if ($offset-$limit) >= 0}
					<a id="prevSearch1" class="searchGo1"  title="{t}Previous{/t}"><img src="/themes/mofilm/images/icons/22x22/prev.png"></a>
					{else}
					<a class="searchGo1" href="" title="{t}Previous{/t}"><img src="/themes/mofilm/images/icons/22x22/prev.png"></a>
					{/if}
			</div>
			<span id="totalb"><strong>Viewing 1-10 of {$totalObjects} Results</strong></span>		
			<div style="width:50px;float:right; padding-right: 350px;">

				{if $offset+$limit < $totalObjects}
					<a id="nextSearch1" class="searchGo1"  title="{t}Next{/t}"><img src="/themes/mofilm/images/icons/22x22/next.png"></a>
					{/if}
			</div>			
