		...
		<div style="height:10px;"></div>	
			...
			<div id="navlink" style="font-size:10px;width:1030px;"> 
				<div style="float:left;width:450px; ">
					...
					{if ($offset-$limit) >= 0}
						<a id="prevSearch1" class="searchsync"  title="{t}Previous{/t}"><img src="/themes/mofilm/images/icons/22x22/prev.png"></a>
						{else}
						<a class="searchsync" href="" title="{t}Previous{/t}"><img src="/themes/mofilm/images/icons/22x22/prev.png"></a>
						{/if}

				</div>
				<span id="totalb" style="width:100%;align:center;">Viewing 1-10 of {$totalObjects} Results</span>

				<div style="float:right;width:250px;padding-right:5px;text-align:right;">
					{if $offset+$limit < $totalObjects}
						<a id="nextSearch1" class="searchsync"  title="{t}Next{/t}"><img src="/themes/mofilm/images/icons/22x22/next.png"></a>
					{/if}
			...
			<div id="musicContent" style="height:auto; background-color:#f0efef;font-size:10px;width:1030px;">
				<table width="1030px;" height="50" border="0" align="center" cellpadding="0" cellspacing="3">
					{foreach $oResults as $oMusic}						
						<tr>
							<td width="20px"><a class="musicPlay" href="{$oMusic->s_url}"><img style="padding-right:10px;" src="/themes/mofilm/images/mm/play.png" height="16px;"></a> </td>
							...
							<td class="syncAudio" style="text-align:right;" width="20px"><img src="/themes/mofilm/images/add.png" height=16px width=16px /></td>
							<td width="40px" align="center" valign="middle"><a style="color:black;" href="/music/license/{$oMusic->s_id}"><img src="/themes/mofilm/images/cart.gif"></a></td>
						</tr>
						<tr>
