	...
	<div id="body">
		<div class="container">
			...
			<div class="floatLeft main">
				<div id="samsungtxt">
					<img src="{$oImagePath}" alt="title" />
					{$oText}
				</div>
				
				<form id="registerForm" action="{$docnEventRegisterUri}" method="POST" name="registerForm" class="dropShadow">
					<h1 class="noMargin">{t}与MOFILM注册{/t}</h1>
					<p>{t}请填写以下表单注册MOFILM帐户{/t}</p>
					...
					<ol class="registrationNotes">
						...
						<li>参与了MOFILM Live活动? 请输入您从活动当天得到的代码以便将来参加我们相关的推广与活动.</li>
					</ol>
					<input type="hidden" name="campaignID" value="{$oCampaignID}">		
				</form>
			...
			<div class="floatRight registerBar">
				...
				<hr />
				<p>在您注册前,请阅读 <a href="{$mofilmWwwUri}/info/userAgreement.html" title="MOFILM: Registered User Agreement">注册用户须知</a></p>
				<hr />
				<p><a href="{$mofilmMyUri}{$activationcnUri}">{t}没有收到激活邮件?{/t}</a></p>
