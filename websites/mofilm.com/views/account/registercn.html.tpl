	...
	<div id="body">
		<div class="container">
			...
			<div class="floatLeft main">
				<form id="registerForm" action="{$docnRegisterUri}" method="post" name="registerForm" class="dropShadow">
			...
			<div class="floatRight registerBar">
				...
				<hr />
				<p>在您注册前,请阅读 <a href="{$mofilmWwwUri}/info/userAgreement" title="MOFILM: Registered User Agreement">注册用户须知</a></p>
				<hr />
