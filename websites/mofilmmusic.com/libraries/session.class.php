...
class mvcSession extends mvcSessionBase {
	 ...
	 */
	function getTracks() {
		return $this->getParam(self::MOMUSIC_TRACKS);
	}
	 ...
	 * @return mvcSession
	 */
	function setTracks($inTrack) {
		
		$this->_MomuicTracks = $this->getParam(self::MOMUSIC_TRACKS);
		$this->_MomuicTracks[$inTrack] = $inTrack;
		$this->setParam(self::MOMUSIC_TRACKS, $this->_MomuicTracks);
		return $this;
	}
