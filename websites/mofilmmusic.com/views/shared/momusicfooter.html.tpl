			...
			<div class="footer_block1">
				...
				<div style="float:left;width:240px;height:100px;padding-left:10px; margin-top:20px;"> 
					...
					<div style="height:20px;font-size: 16px;">   
						<a style="color:#1a263f;" href="http://mofilm.com/business/music">MOMUSIC Services</a> <br /> 
				...
				<div style="height:20px;font-size: 20px;font-weight: bold;color:#525252;"> About Us</div>
					...
					<div style="height:20px;font-size: 16px;">   
						...
						<a style="color:#1a263f;" target="_blank" href="/music/help">FAQs</a>  <br /> 							
                                ...
                                <div style="display: inline;float:left;margin-top: 50px;margin-left: 50px;text-align:center;">TM + © 2015 MOMUSIC, All rights reserved</div>
		</div>
...
<script type="text/javascript" src="/libraries/momusic/jquery.everslider.min.js"></script>
