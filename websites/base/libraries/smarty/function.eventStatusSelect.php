 ...
 * @return string
 */
function smarty_function_eventStatusSelect($params, $smarty, $template = null) {
	require_once(SMARTY_PLUGINS_DIR . 'function.html_options.php');
	
		unset($params['showAll']);
		foreach ( mofilmEvent::getAvailableEventStatuses() as $status ) {
