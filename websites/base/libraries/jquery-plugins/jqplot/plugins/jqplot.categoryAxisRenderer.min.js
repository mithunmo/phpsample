				...
				for (i = 0; i < B.length; i++) {
					...
					if (o.show && o.showLabel) {
						...
						if (o.constructor == a.jqplot.CanvasAxisTickRenderer && o.angle) {
							...
							switch (o.labelPosition) {case"auto":if (z * o.angle < 0) {
							...
							}break;case"end":b = -o.getWidth() + o._textRenderer.height * Math.sin(-o._textRenderer.angle) / 2;break;case"start":b = -o._textRenderer.height * Math.sin(o._textRenderer.angle) / 2;break;case"middle":b = -o.getWidth() / 2 + o._textRenderer.height * Math.sin(-o._textRenderer.angle) / 2;break;default:b = -o.getWidth() / 2 + o._textRenderer.height * Math.sin(-o._textRenderer.angle) / 2;break
							}
						} else {
							b = -o.getWidth() / 2
						}
				...
				for (i = 0; i < B.length; i++) {
					...
					if (o.show && o.showLabel) {
						...
						if (o.constructor == a.jqplot.CanvasAxisTickRenderer && o.angle) {
							...
							switch (o.labelPosition) {case"auto":case"end":if (z * o.angle < 0) {
							...
							}break;case"start":if (o.angle > 0) {
								b = -o._textRenderer.height * Math.cos(-o._textRenderer.angle) / 2
							} else {
								b = -o.getHeight() + o._textRenderer.height * Math.cos(o._textRenderer.angle) / 2
							}break;case"middle":b = -o.getHeight() / 2;break;default:b = -o.getHeight() / 2;break
							}
						} else {
							b = -o.getHeight() / 2
						}
