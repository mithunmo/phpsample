...
(function(e) {
	...
	e.jqplot.PieRenderer.prototype.draw = function(N, V, u, P) {
		...
		if (u.legendInfo && u.legendInfo.placement == "insideGrid") {
			var J = u.legendInfo;
			switch (J.location) {case"nw":s = J.width + J.xoffset;break;case"w":s = J.width + J.xoffset;break;case"sw":s = J.width + J.xoffset;break;case"ne":s = J.width + J.xoffset;v = -1;break;case"e":s = J.width + J.xoffset;v = -1;break;case"se":s = J.width + J.xoffset;v = -1;break;case"n":q = J.height + J.yoffset;break;case"s":q = J.height + J.yoffset;v = -1;break;default:break
			}
		}
			...
			if (this.showDataLabels && V[Q][2] * 100 >= this.dataLabelThreshold) {
				...
				if (this.dataLabels == "label") {
					...
					if (this.dataLabels == "value") {
						...
						D = e.jqplot.sprintf(S, this.data[Q][1])
					} else {
	...
	function h() {
		...
		if (o.length) {
			e(o[0]).before(this.plugins.pieRenderer.highlightCanvas.createElement(this._gridPadding, "jqplot-pieRenderer-highlight-canvas", this._plotDimensions))
		} else {
