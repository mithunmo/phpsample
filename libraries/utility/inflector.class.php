 ...
 * @package scorpio
 * @subpackage utility
 * @category utilityInflector
 */ 
class utilityInflector {
...
/**
 * Encases static text functions for Smarty
 *
 * @package scorpio
 * @subpackage utility
 * @category utilityInflectorWrapper
 * @version $Rev: 364 $
 */
class utilityInflectorWrapper {
	
	function CamelText($text) {
		return utilityInflector::camelize($text);
	}
	
	function lowerCamelText($text) {
		return utilityInflector::variablize($text);
	}
	
	function humanName($text, $upper= false) {
		return utilityInflector::humanize($text, $upper);
	}
	
	function classify($text) {
		return utilityInflector::classify($text);
	}
	
	function tablename($text) {
		return utilityInflector::tableize($text);
	}
	
	function plural($text) {
		return utilityInflector::pluralize($text);
	}
	
	function singular($text) {
		return utilityInflector::singularize($text);
	}
}