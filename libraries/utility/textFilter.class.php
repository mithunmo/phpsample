 ...
 * utilityTextFilter
 * 
 * Stored in utilityTextFilter.class.php
 * 
 * PHP Input Filter
 * InputFilter (PHP5-Strict with comments)
 * @date 10-05-2005
 * @version 1.2.2_php5
 ...
 * utilityTextFilter
 * 
 * Class to filter HTML text strings to remove dangerous tags. This class was created by
 * Daniel Morris <dan@rootcube.com>, with contributions from: Gianpaolo Racca, Ghislain Picard,
 * Marco Wandschneider, Chris Tobin and Andrew Eddie.
 * 
 * 
 * <b>Changes made for Scorpio:</b>
 * 
 * Updated and corrected doc-block comments, and changed class name so it
 * works better with Scorpio framework. Also corrected MySQL method where
 * connection not being used in mysql_real_escape_string() (even though it
 * is being passed in). Made by: Dave Redfern on 11-01-2007.
 *
 * @package scorpio
 * @subpackage utility
 * @category utilityTextFilter
 */
class utilityTextFilter {
	...
	protected function escapeString($string, &$connection) {
		...
		// current function
		else mysql_real_escape_string($string, $connection);
		return $string;
	}
}