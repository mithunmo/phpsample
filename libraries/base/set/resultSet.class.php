 ...
 * baseResultSet Class
 * 
 * Stored in baseResultSet.class.php
 *
 * @author Dave Redfern
 * @copyright Dave Redfern (c) 2007-2010
 * @package scorpio
 * @subpackage base
 * @category baseResultSet
 * @version $Rev: 650 $
 */
 ...
 * baseResultSet Class
 * 
 * A baseResultSet is a wrapper around a resultSet. It takes a set of ID's and allows
 ...
 * @category baseResultSet
 */
abstract class baseResultSet implements IteratorAggregate {
	 ...
	 * @return resultObject
	 */
	function __construct(array $inResults, $inTotalResults = 0, baseSearchInterface $inSearch) {
	 ...
	 * @return baseResultSet
	 */
	function setSearchInterface(baseSearchInterface $inSearchInterface) {
