 ...
 * @package scorpio
 * @subpackage db
 * @category dbDriverSqliteTypes
 * @version $Rev: 650 $
 */


/**
 * dbDriverSqliteTypes Class
 * 
 * dbDriverSqliteTypes definition
 * 
 * @package scorpio
 * @subpackage db
 * @category dbDriverSqliteTypes
 */
class dbDriverSqliteTypes extends dbMapperPhpTypes {
