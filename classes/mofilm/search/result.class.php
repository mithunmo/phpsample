<?php
/**
 * mofilmResultSet Class
 * 
 * Stored in mofilmResultSet.class.php
 *
 * @author Mithun Mohan
 * @copyright Mithun Mohan (c) 2007-2010
 * @package scorpio
 * @subpackage base
 * @category mofilmResultSet
 * @version $Rev: 650 $
 */
 ...
 * mofilmResultSet Class
 * 
 * A mofilmResultSet is a wrapper around a resultSet. It takes a set of ID's and allows
 ...
 * @category mofilmResultSet
 */
class mofilmResultSet implements IteratorAggregate {
