 ...
 * mofilmCorporate
 *
 * Stored in mofilmCorporate.class.php
 *
 * @author Poulami Chakraborty
 * @copyright Mofilm (c) 2009-2010
 * @package mofilm
 * @subpackage mofilmCorporate
 * @category mofilmCorporate
 * @version $Rev: 840 $
 */


/**
 * mofilmCorporate Class
 *
 * Provides access to records in mofilm_content.corporate
 *
 * Creating a new record:
 * <code>
 * $oMofilmCorporate = new mofilmCorporate();
 * $oMofilmCorporate->setID($inID);
 * $oMofilmCorporate->setName($inName);
 * $oMofilmCorporate->setCreateDate($inCreateDate);
 * $oMofilmCorporate->save();
 * </code>
 *
 * Accessing a record by primary key on constructor:
 * <code>
 * $oMofilmCorporate = new mofilmCorporate($inID);
 * </code>
 *
 ...
 * $oMofilmCorporate = new mofilmCorporate();
 * $oMofilmCorporate->setID($inID);
 * $oMofilmCorporate->load();
 * </code>
 *
 * Accessing a record by instance:
 * <code>
 * $oMofilmCorporate = mofilmCorporate::getInstance($inID);
 * </code>
 ...
 * @category mofilmCorporate
 */
class mofilmCorporate implements systemDaoInterface, systemDaoValidatorInterface {
	...
	/**
	 * Container for static instances of mofilmCorporate
	 *
	 * @var array
	 * @access protected
	 * @static
	...
	/**
	 * Returns a new instance of mofilmCorporate
	 *
	 * @param integer $inID
	 * @return mofilmCorporate
	 */
	...
	/**
	 * Get an instance of mofilmCorporate by primary key
	 *
	 * @param integer $inID
	 * @return mofilmCorporate
	 * @static
	...
	/**
	 * Get instance of mofilmCorporate by unique key (ID)
	 *
	 * @param integer $inID
	 * @return mofilmCorporate
	 * @static
	...
	/**
	 * Returns an array of objects of mofilmCorporate
	 *
	 ...
	 * @static
	 */
	public static function listOfObjects($inOffset = null, $inLimit = 30, $eventID = null) {
		/*
	...
	function save() {
		...
		if ( $this->isModified() ) {
			...
			if ( $this->_Modified ) {
				$query = '
				INSERT INTO '.system::getConfig()->getDatabase('mofilm_content').'.corporate
					( ID, name, createDate )
				VALUES
					( :ID, :Name, :CreateDate )
	...
	function delete() {
		$query = '
			DELETE FROM '.system::getConfig()->getDatabase('mofilm_content').'.corporate
			WHERE
				ID = :ID
			LIMIT 1';
	 ...
	 * mofilmCorporate::PRIMARY_KEY_SEPARATOR.
 	 *
	 * @param string $inKey
	 * @return mofilmCorporate
  	 */
