 ...
 * momusicArtist
 *
 * Stored in momusicArtist.class.php
 *
 * @author Mithun Mohan
 * @copyright Mofilm (c) 2009-2010
 * @package momusic
 * @subpackage momusicArtist
 * @category momusicArtist
 * @version $Rev: 840 $
 */
 ...
 * momusicArtist Class
 *
 * Provides access to records in momusic_content.musicArtist
 *
 * Creating a new record:
 * <code>
 * $oMomusicArtist = new momusicArtist();
 * $oMomusicArtist->setID($inID);
 * $oMomusicArtist->setName($inName);
 * $oMomusicArtist->save();
 * </code>
 *
 * Accessing a record by primary key on constructor:
 * <code>
 * $oMomusicArtist = new momusicArtist($inID);
 * </code>
 *
 ...
 * <code>
 * $oMomusicArtist = momusicArtist::getInstance($inID);
 * </code>
 ...
 * @category momusicArtist
 */
class momusicArtist implements systemDaoInterface, systemDaoValidatorInterface {
	...
	/**
	 * Container for static instances of momusicArtist
	 *
	 * @var array
	 * @access protected
	 * @static
	...
	/**
	 * Returns a new instance of momusicArtist
	 *
	 * @param integer $inID
	 * @return momusicArtist
	 */
	...
	/**
	 * Get an instance of momusicArtist by primary key
	 *
	 * @param integer $inID
	 * @return momusicArtist
	 * @static
	...
	/**
	 * Returns an array of objects of momusicArtist
	 *
	...
	public static function listOfObjects($inOffset = null, $inLimit = 30) {
		...
		$query = '
			SELECT ID, name
			  FROM '.system::getConfig()->getDatabase('momusic_content').'.musicArtist
			 WHERE 1';
	...
	function save() {
		...
		if ( $this->isModified() ) {
			...
			if ( $this->_Modified ) {
				$query = '
				INSERT INTO '.system::getConfig()->getDatabase('momusic_content').'.musicArtist
					( ID, name )
				VALUES
					( :ID, :Name )
	...
	function delete() {
		$query = '
			DELETE FROM '.system::getConfig()->getDatabase('momusic_content').'.musicArtist
			WHERE
				ID = :ID
			LIMIT 1';
	 ...
	 * momusicArtist::PRIMARY_KEY_SEPARATOR.
 	 *
	 * @param string $inKey
	 * @return momusicArtist
  	 */
